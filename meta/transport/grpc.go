...
func (g *grpcServer) Get(ctx netcontext.Context, req *meta.GetMetaRequest) (*meta.GetMetaReply, error) {
...
func (g *grpcServer) List(ctx netcontext.Context, req *meta.ListMetaRequest) (*meta.ListMetaReply, error) {
...
func (g *grpcServer) Delete(ctx netcontext.Context, req *meta.DeleteMetaRequest) (*meta.DeleteMetaReply, error) {
	err := g.metaService.Delete(ctx, req.Id)
	if err != nil {
		return nil, err
	}
	return &meta.DeleteMetaReply{}, nil
}
